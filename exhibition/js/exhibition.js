(function () {
  ...
  if (viewer) {
    ...
    var items = Array.prototype.slice.call(document.querySelectorAll("[data-object]"));
    var index = 0;
    ...
    function show(i) {
      ...
      var closeBtn = viewer.querySelector("[data-close]");
    ...
    var close = viewer.querySelector("[data-close]");
    var prev = viewer.querySelector("[data-prev]");
    var next = viewer.querySelector("[data-next]");
