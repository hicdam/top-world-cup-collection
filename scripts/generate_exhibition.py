...
<head>
  ...
  <link rel="stylesheet" href="{prefix}css/exhibition.css?v=type9">
  <script src="{prefix}js/exhibition.js?v=type9" defer></script>
</head>
<body>
{body}
{viewer()}
...
def write_home() -> None:
    ...
    for folder in ROOM_ORDER:
        ...
        rooms.append(
            ...
            f'<span class="n">{esc(ROOM_LABELS[folder])}</span>'
...
<main id="main">
  ...
  <section class="prose">
    ...
    <p>http://www.Top-World-Cup-Collection.ch</p>
  </section>
</main>
{foot("")}
</div>"""
